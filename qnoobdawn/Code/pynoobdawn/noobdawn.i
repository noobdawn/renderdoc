...
#define NOOBDAWN_PLATFORM_LINUX
...
// ignore warning about base class nbdarray<char> methods in nbdstr, and similar warning in structured lists
...
// strip off the NOOBDAWN_ namespace prefix, it's unnecessary. We list this first since we want
// any other subsequent renames to override it.
%rename("%(strip:[NOOBDAWN_])s") "";
...
%ignore nbddatetime;
%ignore nbdstr;
%ignore nbdinflexiblestr;
%ignore nbdfixedarray;
%ignore nbdfixedarray::operator[];
%ignore nbdliteral;
%ignore nbdpair;
%ignore rdhalf;
%ignore bytebuf;

// special handling for NOOBDAWN_GetDefaultCaptureOptions to transform output parameter to a return value
...
// same for NOOBDAWN_GetSupportedDeviceProtocols
%typemap(in, numinputs=0) nbdarray<nbdstr> *supportedProtocols { $1 = new nbdarray<nbdstr>; }
%typemap(argout) nbdarray<nbdstr> *supportedProtocols {
  $result = ConvertToPy(*$1);
  delete $1;
}
%typemap(freearg) nbdarray<nbdstr> *supportedProtocols { }

// same for NOOBDAWN_CreateRemoteServerConnection
...
%ignore nbdarray::nbdarray;
%ignore nbdarray::begin;
%ignore nbdarray::end;
%ignore nbdarray::front;
%ignore nbdarray::back;
%ignore nbdarray::at;
%ignore nbdarray::data;
%ignore nbdarray::assign;
%ignore nbdarray::insert;
%ignore nbdarray::append;
%ignore nbdarray::erase;
%ignore nbdarray::count;
%ignore nbdarray::capacity;
%ignore nbdarray::size;
%ignore nbdarray::byteSize;
%ignore nbdarray::empty;
%ignore nbdarray::isEmpty;
%ignore nbdarray::resize;
%ignore nbdarray::clear;
%ignore nbdarray::reserve;
%ignore nbdarray::swap;
%ignore nbdarray::push_back;
%ignore nbdarray::takeAt;
%ignore nbdarray::indexOf;
%ignore nbdarray::contains;
%ignore nbdarray::removeOne;
%ignore nbdarray::operator=;
%ignore nbdarray::operator[];
...
SIMPLE_TYPEMAPS(nbdstr)
SIMPLE_TYPEMAPS(nbdinflexiblestr)
SIMPLE_TYPEMAPS(nbddatetime)
...
// below
TEMPLATE_ARRAY_DECLARE(nbdarray);
TEMPLATE_FIXEDARRAY_DECLARE(nbdfixedarray);
...
extern "C" PyObject *NOOBDAWN_DumpObject(PyObject *obj);
...
EXTEND_ARRAY_CLASS_METHODS(nbdarray)
...
// If you get an error with add_your_use_of_nbdfixedarray_to_swig_interface missing, add your type here
// or in qnoobdawn.i, depending on which one is appropriate
TEMPLATE_FIXEDARRAY_INSTANTIATE(nbdfixedarray, float, 2)
TEMPLATE_FIXEDARRAY_INSTANTIATE(nbdfixedarray, float, 4)
TEMPLATE_FIXEDARRAY_INSTANTIATE(nbdfixedarray, uint32_t, 2)
TEMPLATE_FIXEDARRAY_INSTANTIATE(nbdfixedarray, uint32_t, 3)
TEMPLATE_FIXEDARRAY_INSTANTIATE(nbdfixedarray, uint32_t, 4)
TEMPLATE_FIXEDARRAY_INSTANTIATE(nbdfixedarray, uint64_t, 4)
TEMPLATE_FIXEDARRAY_INSTANTIATE(nbdfixedarray, int32_t, 4)
TEMPLATE_FIXEDARRAY_INSTANTIATE(nbdfixedarray, ResourceId, 4)
TEMPLATE_FIXEDARRAY_INSTANTIATE(nbdfixedarray, ResourceId, 8)
TEMPLATE_FIXEDARRAY_INSTANTIATE(nbdfixedarray, bool, 4)
TEMPLATE_FIXEDARRAY_INSTANTIATE(nbdfixedarray, bool, 8)
TEMPLATE_FIXEDARRAY_INSTANTIATE(nbdfixedarray, float, 16)
TEMPLATE_FIXEDARRAY_INSTANTIATE(nbdfixedarray, rdhalf, 16)
TEMPLATE_FIXEDARRAY_INSTANTIATE(nbdfixedarray, int32_t, 16)
TEMPLATE_FIXEDARRAY_INSTANTIATE(nbdfixedarray, uint32_t, 16)
TEMPLATE_FIXEDARRAY_INSTANTIATE(nbdfixedarray, double, 16)
TEMPLATE_FIXEDARRAY_INSTANTIATE(nbdfixedarray, uint64_t, 16)
TEMPLATE_FIXEDARRAY_INSTANTIATE(nbdfixedarray, int64_t, 16)
TEMPLATE_FIXEDARRAY_INSTANTIATE(nbdfixedarray, uint16_t, 16)
TEMPLATE_FIXEDARRAY_INSTANTIATE(nbdfixedarray, int16_t, 16)
TEMPLATE_FIXEDARRAY_INSTANTIATE(nbdfixedarray, uint8_t, 16)
TEMPLATE_FIXEDARRAY_INSTANTIATE(nbdfixedarray, int8_t, 16)

// list of array types. These are the concrete types used in nbdarray that will be bound
// If you get an error with add_your_use_of_nbdarray_to_swig_interface missing, add your type here
// or in qnoobdawn.i, depending on which one is appropriate
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, int)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, float)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, uint32_t)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, uint64_t)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, nbdstr)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, WindowingSystem)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, ActionDescription)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, GPUCounter)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, CounterResult)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, APIEvent)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, DescriptorStoreDescription)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, BufferDescription)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, CaptureFileFormat)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, ConstantBlock)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, DebugMessage)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, EnvironmentModification)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, EventUsage)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, PathEntry)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, PixelModification)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, TaskGroupSize)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, MeshletSize)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, ResourceDescription)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, ResourceId)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, LineColumnInfo)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, InstructionSourceInfo)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, ShaderCompileFlag)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, ShaderConstant)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, ShaderDebugState)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, ShaderMessage)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, ShaderResource)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, ShaderSampler)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, ShaderSourceFile)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, ShaderSourcePrefix)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, ShaderVariable)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, ShaderEncoding)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, ShaderVariableChange)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, DebugVariableReference)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, SourceVariableMapping)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, SigParameter)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, TextureDescription)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, ShaderEntryPoint)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, Viewport)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, Scissor)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, ColorBlend)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, BoundVBuffer)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, Offset)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, VertexInputAttribute)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, FloatVector)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, GraphicsAPI)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, GPUDevice)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, ShaderConstantType)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, ShaderChangeStats)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, ResourceBindStats)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, SamplerBindStats)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, ConstantBindStats)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, DescriptorRange)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, Descriptor)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, SamplerDescriptor)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, DescriptorAccess)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, DescriptorLogicalLocation)
TEMPLATE_ARRAY_INSTANTIATE(nbdarray, UsedDescriptor)
TEMPLATE_NAMESPACE_ARRAY_INSTANTIATE(nbdarray, VKPipe, DynamicOffset)
TEMPLATE_NAMESPACE_ARRAY_INSTANTIATE(nbdarray, VKPipe, DescriptorSet)
TEMPLATE_NAMESPACE_ARRAY_INSTANTIATE(nbdarray, VKPipe, DescriptorBuffer)
TEMPLATE_NAMESPACE_ARRAY_INSTANTIATE(nbdarray, VKPipe, ImageData)
TEMPLATE_NAMESPACE_ARRAY_INSTANTIATE(nbdarray, VKPipe, ImageLayout)
TEMPLATE_NAMESPACE_ARRAY_INSTANTIATE(nbdarray, VKPipe, RenderArea)
TEMPLATE_NAMESPACE_ARRAY_INSTANTIATE(nbdarray, VKPipe, XFBBuffer)
TEMPLATE_NAMESPACE_ARRAY_INSTANTIATE(nbdarray, VKPipe, VertexBuffer)
TEMPLATE_NAMESPACE_ARRAY_INSTANTIATE(nbdarray, VKPipe, VertexAttribute)
TEMPLATE_NAMESPACE_ARRAY_INSTANTIATE(nbdarray, VKPipe, VertexBinding)
TEMPLATE_NAMESPACE_ARRAY_INSTANTIATE(nbdarray, VKPipe, ViewportScissor)
TEMPLATE_NAMESPACE_ARRAY_INSTANTIATE(nbdarray, D3D11Pipe, Layout)
TEMPLATE_NAMESPACE_ARRAY_INSTANTIATE(nbdarray, D3D11Pipe, StreamOutBind)
TEMPLATE_NAMESPACE_ARRAY_INSTANTIATE(nbdarray, D3D11Pipe, VertexBuffer)
TEMPLATE_NAMESPACE_ARRAY_INSTANTIATE(nbdarray, D3D12Pipe, Layout)
TEMPLATE_NAMESPACE_ARRAY_INSTANTIATE(nbdarray, D3D12Pipe, ResourceData)
TEMPLATE_NAMESPACE_ARRAY_INSTANTIATE(nbdarray, D3D12Pipe, ResourceState)
TEMPLATE_NAMESPACE_ARRAY_INSTANTIATE(nbdarray, D3D12Pipe, StreamOutBind)
TEMPLATE_NAMESPACE_ARRAY_INSTANTIATE(nbdarray, D3D12Pipe, VertexBuffer)
TEMPLATE_NAMESPACE_ARRAY_INSTANTIATE(nbdarray, D3D12Pipe, RootTableRange)
TEMPLATE_NAMESPACE_ARRAY_INSTANTIATE(nbdarray, D3D12Pipe, RootParam)
TEMPLATE_NAMESPACE_ARRAY_INSTANTIATE(nbdarray, D3D12Pipe, StaticSampler)
TEMPLATE_NAMESPACE_ARRAY_INSTANTIATE(nbdarray, GLPipe, VertexBuffer)
TEMPLATE_NAMESPACE_ARRAY_INSTANTIATE(nbdarray, GLPipe, VertexAttribute)
TEMPLATE_NAMESPACE_ARRAY_INSTANTIATE(nbdarray, GLPipe, TextureCompleteness)
...
extern "C" PyObject *NOOBDAWN_DumpObject(PyObject *obj)
{
  ...
  if(PySequence_Check(obj))
  {
    ...
    for(Py_ssize_t i = 0; i < size; i++)
    {
      ...
      {
        PyObject *childDump = NOOBDAWN_DumpObject(entry);
    ...
    for(Py_ssize_t i = 0; i < size; i++)
    {
      ...
      if(PyBytes_AsStringAndSize(bytes, &buf, &size) == 0)
      {
        ...
        else
        {
          ...
          {
            PyObject *childDump = NOOBDAWN_DumpObject(child);
...
%header %{
  #include <set>
  #include "Code/pynoobdawn/interface_check.h"
  ...
  bool CheckCoreInterface(nbdstr &log)
  {
#if defined(RELEASE)
    return false;
#else
